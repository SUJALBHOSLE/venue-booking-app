...
/**
 * Complete and thorough session sign-out:
 * - Wipes Supabase auth session
 * - Clears session storage, local storage tokens, and active user keys
 * - Invalidates all cookies
 * - Dispatches reactive auth change event
 */
export const performCompleteLogout = async () => {
  ...
  if (typeof window !== 'undefined') {
    ...
    window.localStorage.removeItem('vdt_auth_session_token');
    
    // Wipe Supabase tokens from localStorage
